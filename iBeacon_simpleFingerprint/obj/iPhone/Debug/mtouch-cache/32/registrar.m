...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iBeacon_simpleFingerprint.AppDelegate, iBeacon_simpleFingerprint", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iBeacon_simpleFingerprint.AppDelegate, iBeacon_simpleFingerprint", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iBeacon_simpleFingerprint.AppDelegate, iBeacon_simpleFingerprint", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iBeacon_simpleFingerprint.AppDelegate, iBeacon_simpleFingerprint", "OnActivated");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iBeacon_simpleFingerprint.AppDelegate, iBeacon_simpleFingerprint", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, "iBeacon_simpleFingerprint.AppDelegate, iBeacon_simpleFingerprint", ".ctor");
	}
@end
...
@implementation CoreLocation_CLLocationManager__CLLocationManagerDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, "CoreLocation.CLLocationManager+_CLLocationManagerDelegate, Xamarin.iOS", ".ctor");
	}
@end
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [8].handle = objc_getClass ("NSUUID");
	...
	__xamarin_class_map [15].handle = objc_getClass ("CLRegion");
	...
	__xamarin_class_map [20].handle = objc_getClass ("CLBeaconRegion");
	__xamarin_class_map [21].handle = objc_getClass ("CLBeacon");
	__xamarin_class_map [22].handle = objc_getClass ("CLVisit");
	__xamarin_class_map [23].handle = objc_getClass ("UIApplicationShortcutItem");
	...
	__xamarin_class_map [38].handle = objc_getClass ("CoreLocation_CLLocationManager__CLLocationManagerDelegate");
